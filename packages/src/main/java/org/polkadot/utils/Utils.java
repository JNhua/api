...
public class Utils {
    ...
    public static boolean isHex(Object value, int bitLength, boolean ignoreLength) {
        ...
        boolean isValidHex = "0x".equals(value) || (value instanceof String && Pattern.matches(HEX_REGEX, (CharSequence) value));
...
//  return decoder.decode(value);
     ...
     * ```
     */
    public static String stringUpperFirst(String value) {
        String result = "";
        if(value != null){
